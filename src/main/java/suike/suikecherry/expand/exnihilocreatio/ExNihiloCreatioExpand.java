...
public class ExNihiloCreatioExpand {
    public static void expand() {
        File cfgFile = new File(Config.exnihilocreatioConfigFile, "ExNihiloCreatio.cfg");
        ...
        File sieveRegistryFile = new File(Config.exnihilocreatioConfigFile, "SieveRegistry.json");
